  ...
  return (
    <div className="pt-2 flex gap-4">
      <div className="flex-1">
        <label className="text-xs text-muted-foreground font-bold mb-2 block uppercase tracking-wider">Format File (Koma)</label>
        <input 
          type="text"
      ...
      <div className="flex-1">
        <label className="text-xs text-muted-foreground font-bold mb-2 block uppercase tracking-wider">Maks. Ukuran (MB)</label>
        <input 
          type="number"
