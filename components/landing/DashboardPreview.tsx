  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Link href="/workspace" className="group p-6 rounded-3xl bg-card border border-border hover:border-cyan-500/50 hover:bg-card/80 transition-all duration-300 shadow-xl flex flex-col justify-between h-56 relative overflow-hidden">
