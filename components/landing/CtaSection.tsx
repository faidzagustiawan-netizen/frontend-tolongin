  ...
  return (
    <div className="w-full pb-20">
      <section className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-r from-emerald-950 via-teal-900 to-cyan-950 border border-emerald-500/30 p-6 sm:p-12 lg:p-20 text-center shadow-2xl">
        ...
        >
          <div className="bg-card/60 border border-border rounded-3xl p-6 text-center backdrop-blur-md shadow-2xl relative overflow-hidden group hover:border-emerald-500/50 transition-colors">
          ...
          <div className="bg-card/60 border border-border rounded-3xl p-6 text-center backdrop-blur-md shadow-2xl relative overflow-hidden group hover:border-teal-500/50 transition-colors">
          ...
          <div className="bg-card/60 border border-border rounded-3xl p-6 text-center backdrop-blur-md shadow-2xl relative overflow-hidden group hover:border-amber-500/50 transition-colors">
