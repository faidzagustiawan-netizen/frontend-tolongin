  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 border-t border-border">
      <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
        <h2 className="font-display text-3xl sm:text-5xl font-extrabold text-foreground tracking-tight leading-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="group bg-card border border-border rounded-3xl p-8 shadow-2xl space-y-5 flex flex-col justify-between transition-all duration-300 hover:-translate-y-2 hover:border-emerald-500 hover:ring-1 hover:ring-emerald-400/30 hover:shadow-2xl hover:shadow-emerald-500/20 ">
          <div className="space-y-4">
            <h3 className="font-display text-2xl font-bold text-foreground transition-colors duration-300 group-hover:text-emerald-500">Biometrik Wajah & KTP</h3>
        ...
        <div className="group bg-card border border-border rounded-3xl p-8 shadow-2xl space-y-5 flex flex-col justify-between transition-all duration-300 hover:-translate-y-2 hover:border-emerald-500 hover:ring-1 hover:ring-emerald-400/30 hover:shadow-2xl hover:shadow-emerald-500/20 ">
          <div className="space-y-4">
            <h3 className="font-display text-2xl font-bold text-foreground transition-colors duration-300 group-hover:text-emerald-500">Mesin Koreksi Otomatis AI</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <div className="group bg-card border border-border rounded-3xl p-8 shadow-2xl space-y-5 flex flex-col justify-between transition-all duration-300 hover:-translate-y-2 hover:border-emerald-500 hover:ring-1 hover:ring-emerald-400/30 hover:shadow-2xl hover:shadow-emerald-500/20 ">
          <div className="space-y-4">
            <h3 className="font-display text-2xl font-bold text-foreground transition-colors duration-300 group-hover:text-emerald-500">Gamifikasi Papan Peringkat</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
