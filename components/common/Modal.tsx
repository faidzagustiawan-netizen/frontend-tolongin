      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-20">
          ...
          <motion.div
            ...
            className={cn(
              'relative w-full max-w-lg bg-card border border-border rounded-2xl shadow-2xl overflow-hidden z-50 flex flex-col max-h-[90vh]',
              className
            )}
          >
            {title && (
            ...
            <div className="p-6 overflow-y-auto flex-1 text-muted-foreground">
              {children}
            </div>
          </motion.div>
        </div>
