    ...
    <div className="w-full max-w-4xl mx-auto px-4 py-12 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-8">
        ...
        <motion.div
          ...
          className="bg-card border border-border rounded-3xl p-8 shadow-xl flex flex-col justify-between space-y-6 relative overflow-hidden group hover:border-amber-500/50 transition-colors"
        >
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-2xl font-bold text-foreground">100 Token</h3>
            <p className="text-3xl font-extrabold text-foreground">
              Rp 30.000 <span className="text-sm font-normal text-muted-foreground">/ sekali bayar</span>
            </p>
          ...
          <button
            ...
            className="w-full py-3 rounded-xl font-bold bg-foreground/10 hover:bg-white/20 text-foreground transition-colors flex justify-center items-center gap-2"
          >
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-2xl font-bold text-foreground">500 Token</h3>
            <p className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">
              Rp 100.000 <span className="text-sm font-normal text-muted-foreground">/ sekali bayar</span>
            </p>
            <ul className="space-y-2 text-sm text-muted-foreground pt-4 border-t border-amber-500/30">
              <li className="flex items-center gap-2"><ShieldCheck className="h-4 w-4 text-emerald-400"/> Berlaku selamanya (tidak hangus)</li>
